...
(function () {
    ...
    var TextBlock = P(Node, function (_, super_) {
        ...
        _.jQadd = function (jQ) {
            ...
            if (this.ends[L])
                this.ends[L].jQadd(this.jQ[0].firstChild);
        };
        _.createLeftOf = function (cursor) {
            var textBlock = this;
        ...
        _.html = function () {
            return ('<span class="mq-text-mode" mathquill-command-id=' + this.id + '>'
                + this.textContents()
                + '</span>');
        };
        // editability methods: called by the cursor for editing, cursor movements,
        ...
        _.seek = function (pageX, cursor) {
            ...
            else if (approxPosition >= textPc.text.length)
    ...
    var TextPiece = P(Node, function (_, super_) {
        ...
        _.moveTowards = function (dir, cursor) {
            ...
            if (from)
                ...
                TextPiece(ch).createDir(-dir, cursor);
    ...
    var LatexCommandInput = CharCmds['\\'] = P(MathCommand, function (_, super_) {
        ...
        _.createLeftOf = function (cursor) {
            ...
            if (this._replacedFragment) {
                var el = this.jQ[0];
                this.jQ =
                    this._replacedFragment.jQ.addClass('mq-blur').bind('mousedown mousemove', //FIXME: is monkey-patching the mousedown and mousemove handlers the right way to do this?
                    function (e) {
    ...
    */
    ...
    suite('latex', function () {
        ...
        suite('\\MathQuillMathField', function () {
            ...
            setup(function () {
                outer = MQ.StaticMath($('<span>\\frac{\\MathQuillMathField{x_0 + x_1 + x_2}}{\\MathQuillMathField{3}}</span>')
                    .appendTo('#mock')[0]);
    ...
    suite('Public API', function () {
        ...
        suite('statelessClipboard option', function () {
            ...
            suite('statelessClipboard set to true', function () {
                var mq, textarea;
                setup(function () {
                    mq = MQ.MathField($('<span></span>').appendTo('#mock')[0], { statelessClipboard: true });
                    textarea = $(mq.el()).find('textarea');
                    ;
                });
                teardown(function () {
        ...
        suite('leftRightIntoCmdGoes: "up"/"down"', function () {
            ...
            suite('"up"', function () {
                var mq;
                setup(function () {
                    mq = MQ.MathField($('<span></span>').appendTo('#mock')[0], { leftRightIntoCmdGoes: 'up' });
                });
                teardown(function () {
                    $(mq.el()).remove();
                });
    ...
    suite('tree', function () {
        ...
        suite('disown', function () {
            ...
            test('disowning the right end child', function () {
                ...
                assert.throws(function () { two.disown(); }, 'disown fails on a malformed tree');
            });
            test('disowning the left end child', function () {
                ...
                assert.throws(function () { one.disown(); }, 'disown fails on a malformed tree');
            });
            test('disowning the middle', function () {
                ...
                assert.throws(function () { middle.disown(); }, 'disown fails on a malformed tree');
            });
        });
        ...
        suite('autoCommands', function () {
            ...
            test('command is a built-in operator name', function () {
                ...
                for (var i = 0; i < cmds.length; i += 1) {
                    assert.throws(function () { MQ.config({ autoCommands: cmds[i] }); }, 'MQ.config({ autoCommands: "' + cmds[i] + '" })');
                }
            });
    ...
    suite('up/down', function () {
        ...
        test('\\MathQuillMathField{} in a fraction', function () {
            var outer = MQ.MathField($('<span>\\frac{\\MathQuillMathField{n}}{2}</span>').appendTo('#mock')[0]);
